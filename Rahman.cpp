        ...
        switch (choice) {
            case 1: {
                ...
                if (manager.getEmployeeCount() == 0) {
                    cout << "\tError: No employees exist. Add an employee first." << endl;
                    break;
                }
                ...
                if (!isValidId(idInput, id)) {
                    cout << "\tError: Task ID must be a positive integer." << endl;
                    break;
                }
                cout << "\tEnter priority (Low/Medium/High): ";
                getline(cin, priority);
                if (!isValidPriority(priority)) {
                    cout << "\tError: Priority must be Low, Medium, or High." << endl;
                    break;
                }
                cout << "\tEnter employee ID: ";
                getline(cin, empIdInput);
                if (!isValidId(empIdInput, empId)) {
                    cout << "\tError: Employee ID must be a positive integer." << endl;
                    break;
                }
